...
function signOutput() {
    ...
    signOutput_image.id = 'modalImg_'+sign.signName;
    signOutput_image.alt = sign.signName+' Icon';
    signOutput_signName.innerHTML = sign.signName+' - '+sign.topline;
    ...
    // createSignLinks(); (Disabled ATM)

    openSignOutput();
};

// Sign Links (Disabled ATM)
...
//             event.preventDefault();
//             console.log('The link is: '+signLink.innerHTML);
//             for (i = 0; i < 12; i++) {
//                 if (signLink.innerHTML = signs[i].signName) {
//                     sign = signs[i];
//                     signOutput();
//                     console.log('The link is: '+signLink.innerHTML);
//                     console.log('Found a match: '+signs[i].signName);
//                 }
//             }
//         })
//     })
